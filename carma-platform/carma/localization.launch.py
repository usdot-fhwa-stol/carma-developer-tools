...
def generate_launch_description():
    ...
    declare_single_pcd_path = DeclareLaunchArgument(
        name="single_pcd_path",
        default_value="['/opt/carma/maps/pcd_map.pcd']",
        description="Path to the map pcd file if using the noupdate load type",
    )
    ...
    gnss_to_map_convertor_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[
                    gnss_to_map_convertor_param_file,
    ...
    localization_manager_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                remappings=[],
                parameters=[
                    localization_manager_convertor_param_file,
                    vehicle_config_param_file,
                ],
            )
        ],
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[
                    ...
                    },  # Set to unreasonably high value to ensure no reinitialization occurs as it rarely works
    ...
    subsystem_controller = Node(
        ...
        ],  # Default file is loaded first followed by config file
